...
class AdminApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colorScheme = ColorScheme.fromSeed(
      seedColor: const Color(0xFF202A44),
    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        home: const _AdminAppGate(),
      ),
    );
  }
}

class _AdminAppGate extends StatelessWidget {
  const _AdminAppGate();
  ...
  Widget build(BuildContext context) {
    ...
    if (userProvider.role != UserRole.admin) {
      return _RoleMismatchScreen(
        message: 'This app only accepts admin accounts.',
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.admin_panel_settings_rounded, size: 56),
